...
class NewNetworkMenuAction implements MenuAction
{
  ...
  NewNetworkMenuAction(PApplet context, ObjectProvider objects, HUD hud, Camera cam)
  {
  ...
  public boolean runAction()
  {
      ...
      loginHudCasted.setAction(LoginHUD.CREATE);
